...
<div class="container-xxl py-5">
    <div class="container px-lg-5">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-5">
                <img class="img-fluid wow zoomIn" data-wow-delay="1s" src="{{url('article_pict.png')}}">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="bg-white border border-top-0 p-3">
                        ...
                        @php $count = 1; @endphp
                        @foreach($article_like as $article)
                        <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                            <img class="img-fluid" src="{{url('assets/artikel/'. $article['foto'])}}" alt="">
                            <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                <div class="mb-2">
                                    <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2" href=""></a>
                                    <a class="text-body" href=""><small>{{$article['tanggal']}}</small></a>
                                </div>
                                <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" href="{{route('artikel-detail',$article['_id'] )}}">{{substr($article['judul'], 0,25)}}...</a>
                            </div>
                        </div>
                        @if($count == 4) @php break; @endphp @endif
                        @php $count++; @endphp
                        @endforeach
                        @endif
        ...
        <div class="owl-carousel testimonial-carousel">
            <div class="testimonial-item position-relative bg-light border-top border-5 border-primary rounded p-4 my-4">
                ...
                <div class="d-flex align-items-center">
                    <img class="img-fluid flex-shrink-0 rounded-circle" src="{{url('pfp_arc.png')}}" style="width: 50px; height: 50px;">
